...
urlpatterns = [
    ...
    path('reset_password_complete/', auth_views.PasswordResetCompleteView.as_view(template_name="password/reset_password_complete.html"), name="password_reset_conplete"),
